  ...
  return (
    ...
    >
      <div className="flex text-right flex-col text-base p-2  mb-5">
        <Link to="/" className="mr-2  mt-2 px-3 ">Servicios</Link>        
        <Link to="/" className="mr-2 mt-5 px-3 ">Máquinas Varias</Link>             
        <Link to="/" className="mr-2 mt-5 px-3 ">Volcadores de Bins</Link>             
        <Link to="/" className="mr-2 mt-5 px-3 ">Máquinas Agrícolas</Link>             
        <Link to="/" className="mr-2 mt-5 px-3 ">Elevadores</Link>             
